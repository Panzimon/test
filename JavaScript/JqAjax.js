...
/*
 ...
 第二个参数如果是object，
 jQuery自动把它变成query string然后加到URL后面，实际的URL是：
 ...
 由于JSON用得越来越普遍，
 所以jQuery也提供了getJSON()方法来快速通过GET获取一个JSON对象：
 ...
 jQuery的AJAX完全封装的是JavaScript的AJAX操作，
 所以它的安全限制和前面讲的用JavaScript写AJAX完全一样。
 如果需要使用JSONP，
 可以在ajax()中设置jsonp: 'callback'，
